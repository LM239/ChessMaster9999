...
public class FXMLLauncher extends Application{
	...
	public FXMLLauncher() {
		icon = new Image(FXMLLauncher.class.getResource("img/knighticon.png").toExternalForm());
	}
	
	@Override 
	public void start(final Stage stage) throws IOException {
		FXMLLoader loader = new FXMLLoader(getClass().getResource("ChessGUI_2.0.fxml"));
